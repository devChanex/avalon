...
class ServiceClass
{
    ...
    public function process($data)
    {
        ...
        $sortBy = isset($data['sortBy']) ? $data['sortBy'] : 'opdcid'; // default sort field
        ...
        try {
            ...
            $countQuery = "SELECT COUNT(opdcid) as total  FROM opd_consultation a inner join patients b on a.pid=b.id  $dynamics ";
            ...
            $query = "SELECT a.*,CONCAT(last_name, ' ', suffix, ', ', first_name, ' ', middle_name) as fullname,birth_date,contact_number,gender,present_address FROM opd_consultation a inner join patients b on a.pid=b.id $dynamics  LIMIT :limit OFFSET :offset";
