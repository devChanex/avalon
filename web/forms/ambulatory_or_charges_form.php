...
<body>
    ...
    <h2 class="form-title-long-nomargin">Operating Room Charges</h2>
    <div class="section">
        ...
        <table id="vitalTable"
            ...
            <thead>
                <tr>
                    ...
                    <th style="border: 1px solid black; padding: 6px;">Instrument</th>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", () => {
            try {
                ...
                if (row.orcharges && Array.isArray(row.orcharges)) {
                    ...
                    if (vitalTableBody) {
                        ...
                        <td style="border:1px solid black; padding:5px;">${data.qty || '0'}</td>
                    ...
                    `;
                        ...
                        for (let i = count; i < 25; i++) {
                            const tr = document.createElement("tr");
                            tr.innerHTML = `
                        <td style="border:1px solid black; padding:5px; height:15px;">&nbsp;</td>
