...
<body>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center mb-2">
                                        ...
                                        <div>
                                            ...
                                            <select class="form-control select2 d-inline-block" id="sortBy"
                                                ...
                                                <option value="medcertid">Ref #</option>
                                                <option value="fullname">PatientName</option>
                                                <option value="cert_date">Date</option>
                                                <option value="examined_date">Examined Date</option>
                                ...
                                <template id="dataRowTemplate">
                                    <tr>
                                        <td class="medcertid"></td>
                                        <td class="patientid"></td>
                                        <td class="patientname"></td>
                                        <td class="physician"></td>
                                        <td class="cert_date"></td>
                                        <td class="examined_date"></td>
                                        <td class="days"></td>
                                        <td class="updated"></td>
                                        <td>
                                    ...
                                    <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="fullwindowModalLabel">Medical Certificate
                                                    Form
    ...
    <script src="scripts/medcert-v3.js"></script>
